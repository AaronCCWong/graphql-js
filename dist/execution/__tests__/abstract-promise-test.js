...
(0, _mocha.describe)('Execute: Handles execution of abstract types with promises', function () {
  (0, _mocha.it)('isTypeOf used to resolve runtime type for Interface',
  /*#__PURE__*/
  _asyncToGenerator(
  /*#__PURE__*/
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            PetType = new _.GraphQLInterfaceType({
              name: 'Pet',
              fields: {
                name: {
            ...
            DogType = new _.GraphQLObjectType({
              name: 'Dog',
              interfaces: [PetType],
            ...
            CatType = new _.GraphQLObjectType({
              name: 'Cat',
              interfaces: [PetType],
              isTypeOf: function isTypeOf(obj) {
            ...
            query = "{\n      pets {\n        name\n        ... on Dog {\n          woofs\n        }\n        ... on Cat {\n          meows\n        }\n      }\n    }";
            _context.next = 7;
            return (0, _.graphql)(schema, query);
  ...
  (0, _mocha.it)('isTypeOf can be rejected',
  /*#__PURE__*/
  _asyncToGenerator(
  /*#__PURE__*/
  ...
  (0, _mocha.it)('isTypeOf used to resolve runtime type for Union',
  /*#__PURE__*/
  _asyncToGenerator(
  /*#__PURE__*/
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            PetType = new _.GraphQLUnionType({
              name: 'Pet',
  ...
  (0, _mocha.it)('resolveType on Interface yields useful error',
  /*#__PURE__*/
  _asyncToGenerator(
  /*#__PURE__*/
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            HumanType = new _.GraphQLObjectType({
              name: 'Human',
              fields: {
                name: {
                  type: _.GraphQLString
  ...
  (0, _mocha.it)('resolveType on Union yields useful error',
  /*#__PURE__*/
  _asyncToGenerator(
  /*#__PURE__*/
  ...
  (0, _mocha.it)('resolveType allows resolving with type name',
  /*#__PURE__*/
  _asyncToGenerator(
  /*#__PURE__*/
  ...
  (0, _mocha.it)('resolveType can be caught',
  /*#__PURE__*/
  _asyncToGenerator(
  /*#__PURE__*/
