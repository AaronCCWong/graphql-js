...
var dataType = new _type.GraphQLObjectType({
  name: 'DataType',
  fields: function fields() {
    return {
      ...
      syncNonNullNest: {
        type: (0, _type.GraphQLNonNull)(dataType)
      },
      promiseNest: {
        type: dataType
      },
...
function executeQuery(query, rootValue) {
  return (0, _execute.execute)(schema, (0, _language.parse)(query), rootValue);
      ...
      while (1) {
        switch (_context13.prev = _context13.next) {
          ...
          case 5:
            ...
            (0, _chai.expect)(asyncResult).to.deep.equal(patch(syncResult));
...
(0, _mocha.describe)('Execute: handles non-nullable types', function () {
  (0, _mocha.describe)('nulls a nullable field', function () {
    var query = "\n      {\n        sync\n      }\n    ";
    (0, _mocha.it)('that returns null',
    /*#__PURE__*/
    _asyncToGenerator(
    /*#__PURE__*/
  ...
  (0, _mocha.describe)('nulls a synchronously returned object that contains a non-nullable field', function () {
    var query = "\n      {\n        syncNest {\n          syncNonNull,\n        }\n      }\n    ";
    (0, _mocha.it)('that returns null',
    /*#__PURE__*/
    _asyncToGenerator(
  ...
  (0, _mocha.describe)('nulls an object returned in a promise that contains a non-nullable field', function () {
    var query = "\n      {\n        promiseNest {\n          syncNonNull,\n        }\n      }\n    ";
    (0, _mocha.it)('that returns null',
    /*#__PURE__*/
    _asyncToGenerator(
  ...
  (0, _mocha.describe)('nulls a complex tree of nullable fields, each', function () {
  ...
  (0, _mocha.describe)('nulls the first nullable object after a field in a long chain of non-null fields', function () {
  ...
  (0, _mocha.describe)('nulls the top level if non-nullable field', function () {
    var query = "\n      {\n        syncNonNull\n      }\n    ";
    (0, _mocha.it)('that returns null',
    /*#__PURE__*/
    _asyncToGenerator(
  ...
  (0, _mocha.describe)('Handles non-null argument', function () {
    var schemaWithNonNullArg = new _type.GraphQLSchema({
    ...
    (0, _mocha.it)('succeeds when passed non-null literal value', function () {
    ...
    (0, _mocha.it)('succeeds when passed non-null variable value', function () {
      var result = (0, _execute.execute)({
        schema: schemaWithNonNullArg,
    ...
    (0, _mocha.it)('succeeds when missing variable has default value', function () {
      var result = (0, _execute.execute)({
        schema: schemaWithNonNullArg,
    ...
    (0, _mocha.it)('field error when missing non-null arg', function () {
    ...
    (0, _mocha.it)('field error when non-null arg provided null', function () {
    ...
    (0, _mocha.it)('field error when non-null arg not provided variable value', function () {
    ...
    (0, _mocha.it)('field error when non-null arg provided variable with explicit null value', function () {
      var result = (0, _execute.execute)({
        schema: schemaWithNonNullArg,
        document: (0, _language.parse)("\n          query ($testVar: String = \"default value\") {\n            withNonNullArg (cannotBeNull: $testVar)\n          }\n        "),
        variableValues: {
