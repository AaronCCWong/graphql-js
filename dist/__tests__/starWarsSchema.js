 ...
 *   enum Episode { NEWHOPE, EMPIRE, JEDI }
 */
var episodeEnum = new _type.GraphQLEnumType({
  name: 'Episode',
...
var characterInterface = new _type.GraphQLInterfaceType({
  name: 'Character',
  ...
  fields: function fields() {
    return {
      ...
      friends: {
        type: (0, _type.GraphQLList)(characterInterface),
        description: 'The friends of the character, or an empty list if they ' + 'have none.'
      },
      appearsIn: {
        type: (0, _type.GraphQLList)(episodeEnum),
...
var humanType = new _type.GraphQLObjectType({
  name: 'Human',
...
var droidType = new _type.GraphQLObjectType({
  name: 'Droid',
...
var StarWarsSchema = new _type.GraphQLSchema({
  query: queryType,
