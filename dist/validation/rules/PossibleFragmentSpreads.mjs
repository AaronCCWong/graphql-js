...
export function typeIncompatibleSpreadMessage(fragName, parentType, fragType) {
  return "Fragment \"".concat(fragName, "\" cannot be spread here as objects of ") + "type \"".concat(String(parentType), "\" can never be of type \"").concat(String(fragType), "\".");
}
export function typeIncompatibleAnonSpreadMessage(parentType, fragType) {
  return 'Fragment cannot be spread here as objects of ' + "type \"".concat(String(parentType), "\" can never be of type \"").concat(String(fragType), "\".");
}
/**
