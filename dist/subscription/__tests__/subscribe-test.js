...
var EmailType = new _type.GraphQLObjectType({
  name: 'Email',
  fields: {
    from: {
...
var InboxType = new _type.GraphQLObjectType({
  name: 'Inbox',
  fields: {
    total: {
    ...
    emails: {
      type: (0, _type.GraphQLList)(EmailType)
    }
  }
});
...
var EmailEventType = new _type.GraphQLObjectType({
  name: 'EmailEvent',
  fields: {
    email: {
      type: EmailType
          ...
          case 0:
            ...
            data = {
              ...
              importantEmail: function importantEmail() {
                return (0, _eventEmitterAsyncIterator.default)(pubsub, 'importantEmail');
              }
            };
            defaultAst = (0, _language.parse)("\n    subscription ($priority: Int = 0) {\n      importantEmail(priority: $priority) {\n        email {\n          from\n          subject\n        }\n        inbox {\n          unread\n          total\n        }\n      }\n    }\n  "); // `subscribe` returns Promise<AsyncIterator | ExecutionResult>

            _context26.t0 = sendImportantEmail;
            _context26.next = 9;
            return (0, _subscribe2.subscribe)(schema, ast || defaultAst, data, null, vars);
    ...
    return regeneratorRuntime.wrap(function _callee27$(_context27) {
      while (1) {
        switch (_context27.prev = _context27.next) {
          ...
          case 3:
            _chai.expect.fail('promise should have thrown but did not');
          ...
          case 6:
            ...
            (0, _chai.expect)(_context27.t0 && _context27.t0.message).to.equal(message);
...
(0, _mocha.describe)('Subscription Initialization Phase', function () {
  (0, _mocha.it)('accepts an object with named properties as arguments',
  /*#__PURE__*/
  _asyncToGenerator(
  /*#__PURE__*/
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            document = (0, _language.parse)("\n      subscription {\n        importantEmail\n      }\n    ");
            _context2.next = 5;
            return (0, _subscribe2.subscribe)({
              schema: emailSchema,
              document: document,
              rootValue: {
  ...
  (0, _mocha.it)('accepts multiple subscription fields defined in schema',
  /*#__PURE__*/
  _asyncToGenerator(
  /*#__PURE__*/
    ...
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            pubsub = new _events.default();
            SubscriptionTypeMultiple = new _type.GraphQLObjectType({
              name: 'Subscription',
              fields: {
                importantEmail: {
                  type: EmailEventType
            ...
            testSchema = new _type.GraphQLSchema({
              query: QueryType,
  ...
  (0, _mocha.it)('accepts type definition with sync subscribe function',
  /*#__PURE__*/
  _asyncToGenerator(
  /*#__PURE__*/
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            ast = (0, _language.parse)("\n      subscription {\n        importantEmail\n      }\n    ");
            _context4.next = 5;
            return (0, _subscribe2.subscribe)(schema, ast);
  ...
  (0, _mocha.it)('accepts type definition with async subscribe function',
  /*#__PURE__*/
  _asyncToGenerator(
  /*#__PURE__*/
                        ...
                        return regeneratorRuntime.wrap(function _callee5$(_context5) {
                          while (1) {
                            switch (_context5.prev = _context5.next) {
                              ...
                              case 2:
                                return _context5.abrupt("return", (0, _eventEmitterAsyncIterator.default)(pubsub, 'importantEmail'));
  ...
  (0, _mocha.it)('should only resolve the first field of invalid multi-field',
  /*#__PURE__*/
  _asyncToGenerator(
  /*#__PURE__*/
      ...
      while (1) {
        switch (_context7.prev = _context7.next) {
          case 0:
              ...
              fields: {
                importantEmail: {
                  ...
                  subscribe: function subscribe() {
                    ...
                    return (0, _eventEmitterAsyncIterator.default)(new _events.default(), 'event');
                  }
                },
                nonImportantEmail: {
                  type: EmailEventType,
            ...
            ast = (0, _language.parse)("\n      subscription {\n        importantEmail\n        nonImportantEmail\n      }\n    ");
            _context7.next = 7;
            return (0, _subscribe2.subscribe)(testSchema, ast);

          case 7:
            subscription = _context7.sent;
            subscription.next(); // Ask for a result, but ignore it.

            (0, _chai.expect)(didResolveImportantEmail).to.equal(true);
            (0, _chai.expect)(didResolveNonImportantEmail).to.equal(false); // Close subscription
  ...
  (0, _mocha.it)('throws an error if schema is missing',
  /*#__PURE__*/
  _asyncToGenerator(
  /*#__PURE__*/
        ...
        switch (_context8.prev = _context8.next) {
          case 0:
            ...
            return expectPromiseToThrow(function () {
              return (0, _subscribe2.subscribe)(null, document);
  ...
  (0, _mocha.it)('throws an error if document is missing',
  /*#__PURE__*/
  _asyncToGenerator(
  /*#__PURE__*/
      ...
      while (1) {
        switch (_context9.prev = _context9.next) {
          case 0:
            _context9.next = 2;
            return expectPromiseToThrow(function () {
              return (0, _subscribe2.subscribe)(emailSchema, null);
  ...
  (0, _mocha.it)('resolves to an error for unknown subscription field',
  /*#__PURE__*/
  _asyncToGenerator(
  /*#__PURE__*/
      ...
      while (1) {
        switch (_context10.prev = _context10.next) {
          ...
          case 4:
            ...
            (0, _chai.expect)(subscription).to.deep.equal({
              errors: [{
  ...
  (0, _mocha.it)('throws an error if subscribe does not return an iterator',
  /*#__PURE__*/
  _asyncToGenerator(
  /*#__PURE__*/
    ...
    return regeneratorRuntime.wrap(function _callee11$(_context11) {
      while (1) {
        switch (_context11.prev = _context11.next) {
          case 0:
            invalidEmailSchema = new _type.GraphQLSchema({
              query: QueryType,
              subscription: new _type.GraphQLObjectType({
                name: 'Subscription',
                fields: {
  ...
  (0, _mocha.it)('resolves to an error for subscription resolver errors',
  /*#__PURE__*/
  _asyncToGenerator(
  /*#__PURE__*/
                ...
                return regeneratorRuntime.wrap(function _callee14$(_context14) {
                  while (1) {
                    switch (_context14.prev = _context14.next) {
                      case 0:
                        _context14.next = 2;
                        return (0, _subscribe2.subscribe)(schema, (0, _language.parse)("\n          subscription {\n            importantEmail\n          }\n        "));
  ...
  (0, _mocha.it)('resolves to an error if variables were wrong type',
  /*#__PURE__*/
  _asyncToGenerator(
  /*#__PURE__*/
      ...
      while (1) {
        switch (_context16.prev = _context16.next) {
          case 0:
            ...
            _context16.next = 5;
            return (0, _subscribe2.subscribe)(emailSchema, ast, data, null, {
              priority: 'meow'
            });
...
(0, _mocha.describe)('Subscription Publish Phase', function () {
  (0, _mocha.it)('produces a payload for multiple subscribe in same subscription',
  /*#__PURE__*/
  _asyncToGenerator(
  /*#__PURE__*/
      ...
      while (1) {
        switch (_context17.prev = _context17.next) {
          ...
          case 8:
            ...
            (0, _chai.expect)(sendImportantEmail({
              from: 'yuzhi@graphql.org',
              subject: 'Alright',
              message: 'Tests are good',
              unread: true
  ...
  (0, _mocha.it)('produces a payload per subscription event',
  /*#__PURE__*/
  _asyncToGenerator(
  /*#__PURE__*/
  ...
  (0, _mocha.it)('produces a payload when there are multiple events',
  /*#__PURE__*/
  _asyncToGenerator(
  /*#__PURE__*/
  ...
  (0, _mocha.it)('should not trigger when subscription is already done',
  /*#__PURE__*/
  _asyncToGenerator(
  /*#__PURE__*/
  ...
  (0, _mocha.it)('event order is correct for multiple publishes',
  /*#__PURE__*/
  _asyncToGenerator(
  /*#__PURE__*/
  ...
  (0, _mocha.it)('should handle error during execution of source event',
  /*#__PURE__*/
  _asyncToGenerator(
  /*#__PURE__*/
      ...
      while (1) {
        switch (_context23.prev = _context23.next) {
          case 0:
            ...
            _context23.next = 3;
            return (0, _subscribe2.subscribe)(erroringEmailSchema, (0, _language.parse)("\n        subscription {\n          importantEmail {\n            email {\n              subject\n            }\n          }\n        }\n      "));
          ...
          case 6:
            ...
            (0, _chai.expect)(payload1).to.deep.equal({
              done: false,
              value: {
                data: {
                  importantEmail: {
          ...
          case 10:
            ...
            (0, _chai.expect)(payload2).to.deep.equal({
              done: false,
              value: {
                errors: [{
                  message: 'Never leave.',
          ...
          case 14:
            ...
            (0, _chai.expect)(payload3).to.deep.equal({
              done: false,
              value: {
                data: {
                  importantEmail: {
  ...
  (0, _mocha.it)('should pass through error thrown in source event stream',
  /*#__PURE__*/
  _asyncToGenerator(
  /*#__PURE__*/
    ...
    return regeneratorRuntime.wrap(function _callee25$(_context25) {
      while (1) {
        switch (_context25.prev = _context25.next) {
          ...
          case 16:
            (0, _chai.expect)(expectedError).to.be.instanceof(Error);
            (0, _chai.expect)(expectedError.message).to.equal('test error');
            _context25.next = 20;
            return subscription.next();
