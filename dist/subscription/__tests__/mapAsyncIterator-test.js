...
(0, _mocha.describe)('mapAsyncIterator', function () {
  (0, _mocha.it)('maps over async values',
  /*#__PURE__*/
  _asyncToGenerator(
  /*#__PURE__*/
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            doubles = (0, _mapAsyncIterator.default)(source(), function (x) {
              return x + x;
            });
  ...
  (0, _mocha.it)('maps over async values with async function',
  /*#__PURE__*/
  _asyncToGenerator(
  /*#__PURE__*/
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            doubles = (0, _mapAsyncIterator.default)(source(),
            /*#__PURE__*/
            function () {
  ...
  (0, _mocha.it)('allows returning early from async values',
  /*#__PURE__*/
  _asyncToGenerator(
  /*#__PURE__*/
  ...
  (0, _mocha.it)('passes through early return from async values',
  /*#__PURE__*/
  _asyncToGenerator(
  /*#__PURE__*/
  ...
  (0, _mocha.it)('allows throwing errors through async generators',
  /*#__PURE__*/
  _asyncToGenerator(
  /*#__PURE__*/
    ...
    return regeneratorRuntime.wrap(function _callee11$(_context11) {
      while (1) {
        switch (_context11.prev = _context11.next) {
          ...
          case 23:
            (0, _chai.expect)(caughtError).to.equal('ouch');
            _context11.t7 = _chai.expect;
            _context11.next = 27;
            return doubles.next();
  ...
  (0, _mocha.it)('passes through caught errors through async generators',
  /*#__PURE__*/
  _asyncToGenerator(
  /*#__PURE__*/
  ...
  (0, _mocha.it)('does not normally map over thrown errors',
  /*#__PURE__*/
  _asyncToGenerator(
  /*#__PURE__*/
    ...
    return regeneratorRuntime.wrap(function _callee15$(_context15) {
      while (1) {
        switch (_context15.prev = _context15.next) {
          ...
          case 17:
            (0, _chai.expect)(caughtError && caughtError.message).to.equal('Goodbye');
  ...
  (0, _mocha.it)('maps over thrown errors if second callback provided',
  /*#__PURE__*/
  _asyncToGenerator(
  /*#__PURE__*/
      ...
      while (1) {
        switch (_context17.prev = _context17.next) {
          ...
          case 11:
            ...
            (0, _chai.expect)(result.value).to.be.instanceof(Error);
            (0, _chai.expect)(result.value && result.value.message).to.equal('Goodbye');
            (0, _chai.expect)(result.done).to.equal(false);
        ...
        while (1) {
          switch (_context25.prev = _context25.next) {
            case 0:
              ...
              throwOver1 = (0, _mapAsyncIterator.default)(source(), mapper);
              _context25.t0 = _chai.expect;
              _context25.next = 7;
            ...
            case 18:
              (0, _chai.expect)(expectedError).to.be.an('error');

              if (expectedError) {
                (0, _chai.expect)(expectedError.message).to.equal('Cannot count to 2');
              }

              _context25.t4 = _chai.expect;
              _context25.next = 23;
              return throwOver1.next();
            ...
            case 23:
              ...
              (0, _chai.expect)(didVisitFinally).to.equal(true);
  ...
  (0, _mocha.it)('closes source if mapper throws an error',
  /*#__PURE__*/
  _asyncToGenerator(
  /*#__PURE__*/
  ...
  (0, _mocha.it)('closes source if mapper rejects',
  /*#__PURE__*/
  _asyncToGenerator(
  /*#__PURE__*/
        ...
        while (1) {
          switch (_context27.prev = _context27.next) {
            case 0:
              ...
              throwOver1 = (0, _mapAsyncIterator.default)(source(), function (x) {
                return x;
              }, mapper);
