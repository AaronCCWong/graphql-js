...
export function validateSchema(schema) {
  ...
  !isSchema(schema) ? invariant(0, "Expected ".concat(String(schema), " to be a GraphQL schema.")) : void 0; // If this Schema has already been validated, return the previous results.
