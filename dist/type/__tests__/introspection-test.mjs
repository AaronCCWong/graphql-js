...
import { graphqlSync, GraphQLSchema, GraphQLObjectType, GraphQLList, GraphQLInputObjectType, GraphQLString, GraphQLEnumType } from '../../';
...
describe('Introspection', function () {
  it('executes an introspection query', function () {
    ...
    var result = graphqlSync(EmptySchema, query);
  ...
  it('exposes descriptions on types and fields', function () {
  ...
  it('exposes descriptions on enums', function () {
    var QueryRoot = new GraphQLObjectType({
      name: 'QueryRoot',
      fields: {
        onlyField: {
  ...
  it('executes an introspection query without calling global fieldResolver', function () {
    var QueryRoot = new GraphQLObjectType({
      name: 'QueryRoot',
      fields: {
        onlyField: {
    ...
    var source = getIntrospectionQuery();
    var calledForFields = {};
