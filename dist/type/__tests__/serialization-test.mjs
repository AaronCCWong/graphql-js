...
describe('Type System: Scalar coercion', function () {
  it('serializes output int', function () {
    ...
    expect(GraphQLInt.serialize(-1)).to.equal(-1);
    expect(GraphQLInt.serialize(1e5)).to.equal(100000); // The GraphQL specification does not allow serializing non-integer values
    // as Int to avoid accidental data loss.

    expect(function () {
      return GraphQLInt.serialize(0.1);
    }).to.throw('Int cannot represent non-integer value: 0.1');
    expect(function () {
      return GraphQLInt.serialize(1.1);
    ...
    expect(function () {
      return GraphQLInt.serialize(9876504321);
  ...
  it('serializes output boolean', function () {
